...
pyftsubset Bungee_Color-Regular_svg.ttf --verbose --name-IDs='*' --glyphs-file=subset-glyphs.txt --no-subset-tables+='SVG ' --drop-tables-='SVG ' --output-file=Bungee_Color-Regular-svg-subset.ttf
